import dis_snek
from dis_snek import Scale, InteractionContext
...
class Permissions(Scale):
    ...
    async def admin_grant(self, ctx: InteractionContext,
    ...
    async def admin_revoke(self, ctx: InteractionContext,
    ...
    async def manager_grant(self, ctx: InteractionContext,
                            member: slash_user_option("Member to grant permissions to") = None,
                            user_id: slash_str_option("User ID to grant permissions to") = None,
